const cardData = {
  ...
  card4: {
    A: {
      ...
      text: "<center><strong>Travelling</strong></center><br>You've been planning this the whole year, after finally getting that vacation request approved. Time to enjoy some Mai Tais by a beach somewhere, or go skiing in the mountains. Of course, you have to get there first. And so you muster all your inner peace to brave the train station/airport crowds..."
    },
    B: {
      ...
      text: "<center><strong>Travelling</strong></center><br>And now the crowds are not there. Airports and train stations are empty, as travel restrictions and closed borders halt international and national travels. Vacations are essentially just a pass to not turn on ZOOM for a week. Small victories, I suppose?"
    },
    state: "A"
  },
  card5: {
    A: {
      ...
      text: "<center><strong>The Holidays</strong></center><br>It's finally Christmas! Or the New Year?! ...Maybe Thanksgiving? Okay, definitely Earth Day! No matter, you are just looking forward to eating nana May's cobbler or aunt Mary's cherry pie. Just ready to enjoy some peaceful family time. (Okay, not always peaceful...)"
    },
    B: {
